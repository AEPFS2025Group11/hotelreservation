...
INSERT INTO room (room_id, hotel_id, room_number, type_id, price_per_night, capacity)
VALUES (1, 1, '101', 1, 250.00, 2),
       (2, 1, '102', 2, 400.00, 4),
       (3, 2, '201', 3, 650.00, 4),
       (4, 3, '301', 4, 900.00, 2),
       (5, 4, '401', 5, 1500.00, 3),
       ...
       (8, 7, '301', 4, 900.00, 5),
       (9, 8, '101', 2, 280.00, 2),
       (10, 9, '501', 5, 2000.00, 6),
       (11, 10, '601', 3, 700.00, 4),
       (12, 11, '102', 1, 200.00, 1),
       (13, 12, '202', 2, 340.00, 2),
       (14, 13, '303', 3, 800.00, 4),
       (15, 14, '404', 4, 1200.00, 5),
       (16, 15, '505', 1, 220.00, 1),
       (17, 15, '506', 2, 350.00, 2),
       (18, 15, '507', 3, 620.00, 4),
       (19, 13, '304', 4, 1000.00, 5),
       (20, 14, '405', 5, 1800.00, 6);
